            	 ...
            	 <div class="x_title">
            	  ...
            	  <div class="x_content">
            	  	...
            	  	method="post" enctype="multipart/form-data"
            	  	 data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="verSn" required="required" 
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" name="verSize" required="required" class="form-control col-md-7 col-xs-12" placeholder="请输入版本大小，单位为Mb">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <textarea name="verDesc" class="form-control" rows="3" placeholder='rows="3"'>${appInfo.appDesc }</textarea>
                        </div>
                      </div>
                      <div class="form-group">
